            ...
            <section id="Skills" className="m-2">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-0 lg:divide-y-0 lg:divide-x-4 divide-[#a4a7ad]">
                    ...
                    <div className="flex flex-col gap-4 lg:gap-12">
                        ...
                        <div
                            tabIndex={0}
                            className={`group p-6 flex border-2 border-[oklch(23.26%_0.014_253.1)] flex-col items-center bg-[oklch(23.26%_0.014_253.1)] select-none outline-none focus:outline-none 
                        ...
                        <div
                            tabIndex={0}
                            className={`group p-6 border-2 border-[oklch(23.26%_0.014_253.1)] flex flex-col items-center bg-[oklch(23.26%_0.014_253.1)] transition-shadow duration-300 select-none outline-none focus:outline-none ${isDesktop ? "hover:border-[#c52fee] hover:border-2 hover:shadow-[0_0_20px_#C778DD] rounded-tl-3xl rounded-bl-3xl" : "focus:border-[#c52fee] focus:border-2 focus:shadow-[0_0_20px_#C778DD] active:shadow-[0_0_20px_#C778DD] rounded-3xl"} aos-init aos-animate`} data-aos="flip-up"
                        >
