        ...
        <div className="grid gap-6 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
          {projectsAPI.map(project => (
            <div className="hover-3d">
              <div
                key={project.id}
                className="hover-card grid items-center bg-[#2C2F36] p-4 rounded-lg shadow-md transition-transform duration-300 ease-out hover:-translate-y-2 hover:shadow-xl hover:scale-105"
              >
                <img
                  src={project.image}
