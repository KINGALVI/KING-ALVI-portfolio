                        ...
                        >
                            ...
                            <div className="flex gap-3 justify-center p-4">
                                <a
                                    ...
                                    className="text-[15px] rounded-md btn bg-[#2C2F36] shadow-lg text-[#C778DD] border border-[#C778DD] hover:border-[#c52fee] transition-all duration-300 hover:bg-[#c52fee] hover:text-white hover:shadow-lg hover:-translate-y-1"
                                >
